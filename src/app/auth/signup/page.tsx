...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | SocialScribe - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page SocialScribe Dashboard Template",
  // other metadata
};
