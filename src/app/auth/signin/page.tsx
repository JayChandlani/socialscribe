...
export const metadata: Metadata = {
  title: "Next.js SignIn Page | SocialScribe - Next.js Dashboard Template",
  description: "This is Next.js Signin Page SocialScribe Dashboard Template",
};
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-5">
                  <Link
                   href="/dashboard"
                   className="block text-center w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                  >Sign In</Link>
